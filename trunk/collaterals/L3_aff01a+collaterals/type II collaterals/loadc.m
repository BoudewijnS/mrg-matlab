L3a_coll_m1 = load('L3_aff01a_collII-1int.txt');
L3a_coll_m2 = load('L3_aff01a_collII-2int.txt');
L3a_coll_p1 = load('L3_aff01a_collII1int.txt');
L3a_coll_p2 = load('L3_aff01a_collII2int.txt');
L3a_coll_p3 = load('L3_aff01a_collII3int.txt');
L3a_coll_p4 = load('L3_aff01a_collII4int.txt');
L3a_coll_p5 = load('L3_aff01a_collII5int.txt');
L3a_coll_p6 = load('L3_aff01a_collII6int.txt');
